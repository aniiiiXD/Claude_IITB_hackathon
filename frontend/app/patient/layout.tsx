...
import { Dna, LayoutDashboard, Shield, Users, MessageSquarePlus } from 'lucide-react';
import { RoleSwitcher } from '@/components/layout/role-switcher';
import { useRequireRole } from '@/lib/mock-session';

const NAV = [
  { href: '/patient/dashboard', label: 'My Record', icon: LayoutDashboard },
  { href: '/patient/submit', label: 'Submit Symptoms', icon: MessageSquarePlus },
  { href: '/patient/consent', label: 'Consent', icon: Shield },
          ...
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[10px] tracking-wide" style={{ color: '#5C7855' }}>Your health record</span>
              </div>
            </Link>
              ...
              {NAV.map(item => {
                ...
                return (
                  <Link
                    ...
                    style={{
                      background: active ? 'rgba(92,120,85,0.1)' : 'transparent',
                      color: active ? '#5C7855' : '#6B7D93',
                    }}>
